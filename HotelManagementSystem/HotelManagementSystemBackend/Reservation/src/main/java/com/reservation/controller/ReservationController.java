...
public class ReservationController {
	...
	public ResponseEntity<String> modifyBooking(@PathVariable long BookingId ,@PathVariable String field , @PathVariable Object value) {
		return new ResponseEntity<>(serviceImpl.modifyBooking(BookingId , field , value), HttpStatus.OK);
	}
